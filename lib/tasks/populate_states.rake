...
task :populate_states => [:environment] do
    ...
    Addresses::State.create(id: '46', name: 'Rio de Janeiro', acronym: 'RJ', country_id: 33, relevance:100)
    ...
    Addresses::State.create(id: '53', name: 'São Paulo', acronym: 'SP', country_id: 33, relevance:100)
