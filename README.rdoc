...
* Simple_form
    ...
    <%= f.input :cep, as: :cep_autocomplete, required:true, input_html: { class:'mask', mask_place_holder: '_____-___', mask_format:'00000-000' }, loader:'.cep-uil-default-css', update_elements:{ address:'#customer_address', cidade:'#customer_city', uf:'#customer_state'} %>
